...
- [ ] **Phase 7 — Evaluate:** Transfer adapters to Mac, re-run A/B with fine-tuned models + live YT comparison — **WSL→Mac handoff:** [`docs/wsl_pipeline_refresh.md`](./docs/wsl_pipeline_refresh.md) §5.
