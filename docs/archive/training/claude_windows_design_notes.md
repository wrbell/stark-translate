# CLAUDE-windows.md — design-era long form (historical snapshot)

> **Historical.** This is the long-form WSL training guide as it stood at commit `c5fb689`
> (2026-09-10), preserved before `CLAUDE-windows.md` was condensed to source-verified
> content. The embedded code samples are the original 2026-03/04 design notes for
> `training/preprocess_audio.py`, `assess_quality.py`, `prepare_bible_corpus.py`,
> `train_whisper.py`, `train_gemma.py` (TranslateGemma) and `evaluate_translation.py`.
> They were **not** re-verified against the current scripts and their numbers are the
> original estimates. Current guidance: [`CLAUDE-windows.md`](../../../CLAUDE-windows.md),
...
> **Parent doc:** [`CLAUDE.md`](../../../CLAUDE.md) · **Backlog:** [`docs/backlog.json`](../../backlog.json)
...
> Gemma 4 E4B domain SFT, W17 and the [CUDA latency proposal](../../cuda_latency_proposal.md)
...
[`docs/wsl_pipeline_refresh.md`](../../wsl_pipeline_refresh.md):
...
> **Superseded by the Gemma 4 program** ([`docs/gemma4_tuning/overview.md`](../../gemma4_tuning/overview.md)):
...
> ([`docs/platense_alignment_bug.md`](../../platense_alignment_bug.md)). Results so far:
> [`docs/gemma4_tuning/v1_results.md`](../../gemma4_tuning/v1_results.md) — parity with stock
