...
| L6 audited Torch 2.13 candidate env from main | RUNNING | 2026-09-11T02:07Z | | | | build/resolve/install off-GPU; EN/ES replay checks + 3 paired replays on GPU; launcher untouched |
