...
|---|---|---|---|---|---|---|
| S0 pre-flight (caffeinate, worktrees, status branch) | RUNNING | 2026-09-11T15:11Z | | | | |
| P1 promotion source PR (Codex) | PENDING | | | | | pyproject pins, preflight bounds, `.stark-python` pointer, constraints file, docs |
...
| D1 PyPI deferral (workflow gate + backlog) | PENDING | | | | | |
| X1 tail harness + `serial_finals` flag PR (Codex) | PENDING | | | | | |
