...
- **Sources:** `pyproject.toml`, `constraints/macos-arm64-py311-runtime.txt`, `scripts/runtime_env.sh`, `operator_app/preflight.py`, `docs/packaging/macos.md`, `docs/evaluation/followup_20260911/P-torch213-promotion/README.md`, `docs/evaluation/followup_20260911/STATUS.md`
