# Historical Mac pipeline refresh — August 30, 2026

Archived design and benchmark record. Use the
[current Mac runbook](mac_pipeline_refresh.md); commands below include superseded
defaults, unavailable MTP and old installation assumptions.
