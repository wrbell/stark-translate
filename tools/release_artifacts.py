...
RUNTIME_REQUIRED = {
    ...
    "operator_app/audio_tests.py",
    "operator_app/lite_preflight.py",
    ...
    "engines/stt_fallback.py",
    "tools/audio_bridge_client.py",
    "tools/review_data.py",
    "tools/session_lifecycle.py",
    "tools/vad_runtime.py",
    "tools/marian_ct2_setup.py",
    "tools/capture_worker.py",
    "tools/isolated_audio.py",
    "tools/capture_handoff.py",
    "tools/replay_client_barrier.py",
    "tools/caption_delivery.py",
    "tools/display_server.py",
    "tools/latency_scheduler.py",
    "tools/preview_candidates.py",
    "tools/operational_logging.py",
    "tools/persistence.py",
    "tools/pipeline_health.py",
    "tools/endurance_monitor.py",
...
SOURCE_REQUIRED = {
    ...
    "tests/test_mac_setup_runtime.py",
}
